...
<script src="{{'/_js/slippry/dist/slippry.min.js'}}"></script>
<link rel="stylesheet" href="{{'/_js/slippry/dist/slippry.css'}}"/>
<script src="//cdn.ckeditor.com/4.5.10/standard/ckeditor.js"></script>
<script src="{{ '/_js/carousel/jquery.lbslider.js' }}"></script>
